...
export default function WalletMenu({ onStatus }: WalletMenuProps) {
  ...
  useEffect(() => {
    ...
    const sinceKey = `megaeth-launchpad.wallet-since.${normalizedAddress}`;
    const txKey = `megaeth-launchpad.wallet-tx-count.${normalizedAddress}`;
        ...
        {open ? (
          <div className="wallet-popover wallet-connect-popover">
            ...
            <footer className="wallet-pop-footer wallet-connect-footer">
              <img src={MEGAETH_LOGO_ASSET} alt="MegaETH logo" className="wallet-pop-brand-logo" />

...
const BRAND_NAME = process.env.NEXT_PUBLIC_BRAND_NAME || "MEGAETH";
const BLOCK_EXPLORER_URL = process.env.NEXT_PUBLIC_BLOCK_EXPLORER_URL || "";
const DEFAULT_COLLECTION_NAME = process.env.NEXT_PUBLIC_COLLECTION_NAME || "COSMIC ENTITIES";
const DEFAULT_COLLECTION_DESCRIPTION =
  process.env.NEXT_PUBLIC_COLLECTION_DESCRIPTION ||
  "A collection of on-chain entities built for the MegaETH real-time network. Minting access, phase control, allowlist logic, and fee settings are fully integrated in this launchpad.";
      ...
      <footer className="mint-ui-site-footer">
        ...
        <section className="mint-ui-footer-panel">
          <div className="mint-ui-footer-meta-row">
            <p className="mint-ui-footer-copyright">© 2026 MEGAETH. ALL RIGHTS RESERVED.</p>
          </div>
          <img src={DEFAULT_BRAND_LOGO_ASSET} alt="MegaETH" className="mint-ui-footer-wordmark-logo" />
        </section>
      </footer>
